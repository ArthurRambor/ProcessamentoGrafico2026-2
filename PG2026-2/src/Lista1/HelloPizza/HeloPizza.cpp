...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Ola pizza ! -- Arthur", nullptr, nullptr);
	if (!window)
	{
	...
	while (!glfwWindowShouldClose(window))
	{
		// Este trecho de código é totalmente opcional: calcula e mostra a contagem do FPS na barra de título
		{
			...
			if (title_countdown_s <= 0.0 && elapsed_s > 0.0)
			{
				...
				char tmp[256];
				sprintf(tmp, "Ola pizza! -- Arthur\tFPS %.2lf", fps);
        ...
        glUniform4f(colorLoc, 0.5f, 0.5f, 0.0f, 1.0f); // enviando cor para variável uniform inputColor
    	glDrawArrays(GL_LINE_LOOP, 0, 5); // T0: v0, v1, v2 → fecha o triângulo sozinho

        // Rodelas de pepperoni (vermelhas)
        glUniform4f(colorLoc, 1.0f, 0.0f, 0.0f, 1.0f); // vermelho
        glDrawArrays(GL_TRIANGLE_FAN, 5, 10);  // rodela 1
        glDrawArrays(GL_TRIANGLE_FAN, 15, 10); // rodela 2
        glDrawArrays(GL_TRIANGLE_FAN, 25, 10); // rodela 3
...
int setupGeometry()
{
    ...
    0.462,  0.191, 0.0,   // v1  - 22.5°
    0.354,  0.354, 0.0,   // v2  - 45°
    0.191,  0.462, 0.0,   // v3  - 67.5°
    0.000,  0.500, 0.0,   // v4  - 90°

    // ===== RODELA 1 (índices 5-14), centro em (0.10, 0.10), raio 0.04 =====
    0.100, 0.100, 0.0,  // v5  - centro
    0.140, 0.100, 0.0,  // v6  - 0°
    0.128, 0.128, 0.0,  // v7  - 45°
    0.100, 0.140, 0.0,  // v8  - 90°
    0.072, 0.128, 0.0,  // v9  - 135°
    0.060, 0.100, 0.0,  // v10 - 180°
    0.072, 0.072, 0.0,  // v11 - 225°
    0.100, 0.060, 0.0,  // v12 - 270°
    0.128, 0.072, 0.0,  // v13 - 315°
    0.140, 0.100, 0.0,  // v14 - fecha (repete v6)

    // ===== RODELA 2 (índices 15-24), centro em (0.22, 0.22), raio 0.04 =====
    0.220, 0.220, 0.0,  // v15 - centro
    0.260, 0.220, 0.0,  // v16 - 0°
    0.248, 0.248, 0.0,  // v17 - 45°
    0.220, 0.260, 0.0,  // v18 - 90°
    0.192, 0.248, 0.0,  // v19 - 135°
    0.180, 0.220, 0.0,  // v20 - 180°
    0.192, 0.192, 0.0,  // v21 - 225°
    0.220, 0.180, 0.0,  // v22 - 270°
    0.248, 0.192, 0.0,  // v23 - 315°
    0.260, 0.220, 0.0,  // v24 - fecha (repete v16)

    // ===== RODELA 3 (índices 25-34), centro em (0.15, 0.28), raio 0.04 =====
    0.150, 0.280, 0.0,  // v25 - centro
    0.190, 0.280, 0.0,  // v26 - 0°
    0.178, 0.308, 0.0,  // v27 - 45°
    0.150, 0.320, 0.0,  // v28 - 90°
    0.122, 0.308, 0.0,  // v29 - 135°
    0.110, 0.280, 0.0,  // v30 - 180°
    0.122, 0.252, 0.0,  // v31 - 225°
    0.150, 0.240, 0.0,  // v32 - 270°
    0.178, 0.252, 0.0,  // v33 - 315°
    0.190, 0.280, 0.0,  // v34 - fecha (repete v26)
	};
