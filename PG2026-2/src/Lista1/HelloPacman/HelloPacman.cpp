...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Ola pacman ! -- Arthur", nullptr, nullptr);
	if (!window)
	{
	...
	while (!glfwWindowShouldClose(window))
	{
		// Este trecho de código é totalmente opcional: calcula e mostra a contagem do FPS na barra de título
		{
			...
			if (title_countdown_s <= 0.0 && elapsed_s > 0.0)
			{
				...
				char tmp[256];
				sprintf(tmp, "Ola pacman! -- Arthur\tFPS %.2lf", fps);
		...
		glDrawArrays(GL_TRIANGLE_FAN, 0, 16); // cria o polígono
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		// x   y     z
		// T0
    0.000,  0.000, 0.0,   // v0  - centro (pivô do fan / "bico" da boca)
    0.462,  0.191, 0.0,   // v1  - 22.5°
    0.354,  0.354, 0.0,   // v2  - 45°
    0.191,  0.462, 0.0,   // v3  - 67.5°
    0.000,  0.500, 0.0,   // v4  - 90°  (topo)
    -0.191,  0.462, 0.0,   // v5  - 112.5°
    -0.354,  0.354, 0.0,   // v6  - 135°
    -0.462,  0.191, 0.0,   // v7  - 157.5°
    -0.500,  0.000, 0.0,   // v8  - 180° (esquerda)
    -0.462, -0.191, 0.0,   // v9  - 202.5°
    -0.354, -0.354, 0.0,   // v10 - 225°
    -0.191, -0.462, 0.0,   // v11 - 247.5°
    0.000, -0.500, 0.0,   // v12 - 270° (embaixo)
    0.191, -0.462, 0.0,   // v13 - 292.5°
    0.354, -0.354, 0.0,   // v14 - 315°
    0.462, -0.191, 0.0,   // v15 - 337.5°
        // boca aberta entre v15 (337.5°) e v1 (22.5°), passando pelo 0° (direita)
		// T1
